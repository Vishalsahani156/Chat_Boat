        ...
        <div className="p-4 border-b border-dark-700">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-lg font-semibold text-white">AI Chatbot</h1>
            </div>
            <button
              onClick={onClose}
              className="md:hidden p-1 rounded-lg hover:bg-dark-700 text-dark-300"
            >
              <X size={20} />
            </button>
          </div>
          <button
            ...
            className="w-full flex items-center gap-2 px-4 py-2.5 rounded-lg
              ...
              text-dark-200 transition-colors duration-200"
          >
            <Plus size={18} />
                ...
                >
                  ...
                  <button
                    ...
                    className="opacity-0 group-hover:opacity-100 p-1 rounded hover:bg-dark-600 
                      text-dark-400 hover:text-red-400 transition-all duration-150"
                  >
                    <Trash2 size={14} />
                  </button>
                </div>
